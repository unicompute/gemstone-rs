...
def build_targets() -> tuple[BuildTarget, ...]:
    ...
    return (
        ...
        BuildTarget("feature-map", "gemstone-rs Feature Map", "Crates, examples, docs, and gemstone-py parity references", (DOCS_DIR / "feature-map.md",), cover),
        ...
        BuildTarget("gemstone-js-vs-gemstone-py", "gemstone-js vs gemstone-py", "TypeScript and Python GemStone/S bridge comparison", (DOCS_DIR / "gemstone-js-vs-gemstone-py.md",), cover),
        ...
        BuildTarget("profile-schema", "gemstone-rs Codegen Profile Schema", "Project profile JSON validation for explorer and VS Code workflows", (DOCS_DIR / "profile-schema.md",), cover),
        ...
        BuildTarget("screenshots", "gemstone-rs Screenshot Workflow", "Repeatable Explorer and Workbench screenshot capture", (DOCS_DIR / "screenshots.md",), cover),
