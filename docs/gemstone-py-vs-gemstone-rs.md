...
TypeScript/Python track and reports **11 batches**, roughly **68-119 hours**
total.
...
| Batch | Work | Estimate |
| --- | --- | ---: |
| 1 | Object mapping maturity | 4-8 hours |
...
Total: roughly **26-47 hours** to bring `gemstone-rs` materially closer to
