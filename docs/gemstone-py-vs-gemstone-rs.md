...
TypeScript/Python track and reports **11 batches**, roughly **67-117 hours**
total.
...
| Batch | Work | Estimate |
| --- | --- | ---: |
| 1 | Object mapping maturity | 3-6 hours |
...
Total: roughly **25-45 hours** to bring `gemstone-rs` materially closer to
