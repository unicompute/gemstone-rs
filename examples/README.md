...
`smoke_dry_run_json`, `migration_json`, `compatibility_json`, and
`conformance_json`, plus direct `NativeSession` methods for eval, execute,
resolve, perform, globals, export-set retention, and transactions.
